...
ALTER TABLE `cart`
    ADD CONSTRAINT `FK_MEMBER_ID_FOR_CART`
        FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `cart_detail`
    ADD CONSTRAINT `FK_CART_ID_FOR_CART_DETAIL`
        FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `cart_detail`
    ADD CONSTRAINT `FK_PRODUCT_ID_FOR_CART_DETAIL`
        FOREIGN KEY (`product_id`) REFERENCES `product` (`proudct_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `orders`
    ADD CONSTRAINT `FK_MEMBER_ID_FOR_ORDERS`
        FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `order_product`
    ADD CONSTRAINT `FK_ORDERS_ID_FOR_ORDER_PRODUCT`
        FOREIGN KEY (`orders_id`) REFERENCES `orders` (`orders_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE `order_product`
    ADD CONSTRAINT `FK_PRODUCT_ID_FOR_ORDER_PRODUCT`
        FOREIGN KEY (`product_id`) REFERENCES `orders` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
